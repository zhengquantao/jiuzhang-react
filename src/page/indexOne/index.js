...
class EchartsTests extends Component {
    ...
    componentWillMount(){
        ...
        const today_time = today.getFullYear() + '-' + (today.getMonth() + 1) + '-' + today.getDate()
         axios.post('http://127.0.0.1:8000/api/v1/filter/', {"index": 1,
        ...
        return (
            <div>
                <Row style={{marginTop:50}}>
                    <Col span={3} offset={2}><strong style={{fontSize:"20px"}}>优先级一</strong>&nbsp;&nbsp;</Col>
...
const TableOne =  Form.create()(EchartsTests);
